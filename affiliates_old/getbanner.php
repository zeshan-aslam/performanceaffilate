...
*/
 ...
 ?>
	    ...
	    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse"  width="68%" id="AutoNumber1"  align="center">
	    <tr>
	    ...
	    <table border="0" align='center' cellpadding="0" cellspacing="0" style="border-collapse: collapse; text-align: center" width="90%" id="AutoNumber4"  class="tablebdr">
	    <tr>
	  ...
	  <!--Choose Sub-ID-->									 
                    ...
                    <?php    ///////////// display  banners /////////////
                       ...
                       ?>
                                  ...
                                  <td width="94%" height="19" class='textred' colspan="2"><b><?=$lang_banner_norec?></b></td>
                                  </tr>
								  <tr>
                ...
                <table cellspacing="0" cellpadding=5 width='701' border=1  style="border-collapse: collapse" >
                <tbody>
                <tr>
                <td height='1' width='593' class="grid2">

                <a href='<?=$row->banner_url?>' target='new'>
                <img src='<?=$row->banner_name?>' border='0' width="<?=$row->banner_width?>" height="<?=$row->banner_height?>"></a></td>
                </tr>
                ...
                <textarea rows="14" name="S1" cols="85">
