...
demo = {
    ...
    initDashboardPageCharts: function() {
		...
		yearclick = JSON.parse(yearclick);
		yearsale = JSON.parse(yearsale);
        var data = {
            labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
            series: [
                [checknull(yearclick['Jan']), checknull(yearclick['Feb']), checknull(yearclick['Mar']), checknull(yearclick['Apr']), checknull(yearclick['May']), checknull(yearclick['Jun']), checknull(yearclick['Jul']), checknull(yearclick['Aug']), checknull(yearclick['Sep']), checknull(yearclick['Oct']), checknull(yearclick['Nov']), checknull(yearclick['Dec'])],
                [checknull(yearsale['Jan']), checknull(yearsale['Feb']), checknull(yearsale['Mar']), checknull(yearsale['Apr']), checknull(yearsale['May']), checknull(yearsale['Jun']), checknull(yearsale['Jul']), checknull(yearsale['Aug']), checknull(yearsale['Sep']), checknull(yearsale['Oct']), checknull(yearsale['Nov']), checknull(yearsale['Dec'])],
            ]
        };
    ...
    showNotification: function(from, align) {
        ...
        $.notify({
            icon: "nc-icon nc-app",
            message: "Welcome to <b>Merchant Dashboard</b>."
