...
/************************************************************************/
  ...
  $totallink =	explode('~',$totallink);
	...
	if($msg == "hasProgram")
	{
		$msg = "Merchant can only create 1 Program";
	}
		...
		<div class="col-md-12"> 
			<div class="card stacked-form">
				<div class="card-header">
						<div class="card-title"><a href="index.php?Act=programs&mode=newprogram" class="btn btn-primary btn-wd"><?= $lpgm_CREATEPROGRAME ?></a>
						<a class="btn btn-info btn-wd" href='index.php?Act=programs&amp;mode=editprogram&amp;programId=<?=$programId?>'><?=$lpgm_Edit?></a> 
				     	<a class="btn btn-danger btn-wd" href='index.php?Act=programs&amp;mode=deleteprogram&amp;programId=<?=$programId?>' id="del" onclick="return del_onclick()"><?=$lpgm_Delete?></a>
              ...
              <!-- 
						...
						<span>
							...
							if($programDetails['status'] == 'active'){
								echo '<span class="btn btn-success btn-wd">'.ucwords($programDetails['status']).'</span>'; 
							}else if($programDetails['status'] == 'pending'){
								echo '<span class="btn btn-wd btn-danger btn-outline">'.ucwords($programDetails['status']).'</span>';
							}else{
								echo '<span class="btn btn-wd btn-warning btn-outline">'.ucwords($programDetails['status']).'</span>';
							}
					...
					<!-- <div class="row">
						...
						<div class="col-md-4">
							<a class="btn btn-info btn-wd" href="index.php?Act=uploadProducts&amp;pgmid=<?=$programId?>"><?=$lang_upload_prd?></a>
						</div>
						<div class="col-md-6 text-center">
							<a class="btn btn-info btn-wd" href='index.php?Act=programs&amp;mode=deleteprogram&amp;programId=<?=$programId?>' id="del" onclick="return del_onclick()"><?=$lpgm_Delete?></a>
						</div> 
					</div> -->
				<!-- </div>
			</div>
		...
		<div class="col-md-4 mr-auto ml-auto">
			<div class="card"> 
				<div class="card-body text-center">
					<a href="index.php?Act=listaffiliate&amp;pgmid=<?=($programId)?$programId:0?>">
				 <?=$lpgm_RegisteredAffiliates?>&nbsp; -<?=$afftotal[0]?></a>	
				</div>
			</div>
		</div>
		<div class="col-md-4 mr-auto ml-auto">
			<div class="card">
				<div class="card-body text-center">
					<a href="index.php?Act=waitingaff&amp;pgmid=<?=($programId)?$programId:0?>">
				  <?=$lpgm_WaitingAffiliates?> -<?=$afftotal[1]?> </a>
				</div>
			</div>
		</div>
	</div> -->
					...
					<div class="row">
						<div class="col-md-12">
							...
							<label><?=$lpgm_Description?></label>
								<span><?=nl2br($programDetails['description'])?></span>
							</div>
						</div>
					</div>
				</div>
