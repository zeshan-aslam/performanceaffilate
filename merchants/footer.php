	...
	<div class="container">
		<nav>
			...
			<p class="copyright text-center">
				...
				<a href="https://www.searlco.com">Searlco LTD</a>, Performance Affiliate Network
			</p>
		</nav>
	</div>
</footer>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function($) {
		$('.selectpickeraffilate').on('change', function(e) {
			var val = $(this).val();
			var splitval = val.split('~');
			if (splitval[1] == 'ViewProfile') {
				$('#myModal' + splitval[2]).modal('show');
			} else {
				$('#f' + splitval[0]).submit();
			}
		});
	...
	function deletetablerow(cust_id, cust_name, tablename, returnurl) {
		var action = 'delete';
