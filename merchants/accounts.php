...
if ($err == "") {
    ...
    while ($row = mysqli_fetch_object($res)) {
        ...
        $competitor_urls                 = stripslashes(trim($row->competitor_urls));
    }
}  //closing of err if
$competitor_url_Array = explode('|', $competitor_urls);
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card stacked-form">
            <div class="card-header">
                ...
                <h4 class="card-title">Manage Competitor URLs</h4>

                <span class="textred"></span>
            </div>
            <div class="card-body wrappers">
                <div class="contents">
                    <ul class="exampleURL"><input type="text" class="input_exampleURL" spellcheck="false"></ul>
                </div>

                <div class="URLmessage_box" style="margin:10px 0px;">
    ...
    <!-- <div class="col-md-6">
        <div class="card stacked-form">
            <div class="card-header">
                <h4 class="card-title">Available Competitors URLs</h4>
            </div>
            <div class="card-body">
                <div class="row" id="responseUrl">
                    <?php
                    foreach ($competitor_url_Array as $key => $value) {
                        if ($value !== '') {
                    ?>
                            <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select multiple id=Country name="Countrypromotion[]" data-placeholder="Select a Country" name="categorylst" class="custom-select form-control">
                                    ...
                                    while ($row = mysqli_fetch_object($result2)) {
                                        ...
                                        $key = array_search($row->country_no, $cops);
        ...
        <div class="card stacked-form">
            <form method="post" name="signup" action="" onSubmit="return ValidateSignUp();">
                ...
                <div class="card-body">
                    ...
                    <!--===============Start Entcryption of Merchant ID =================-->
                    <?php
                    $merID_Encrypted = MultipleTimeEncode($MERCHANTID);
                    $progID_Encrypted = MultipleTimeEncode($program);
                    ?>
                    <!--===============End Entcryption of Merchant ID =================-->
                    <div class="text-center">
                        <p><?= $lang_affiliateLinkHelp ?></p>
                        <p><b><a href="<?= $track_site_url . "/performanceAffiliateClone/index.php?Act=Affiliates&MID=$merID_Encrypted&PID=$progID_Encrypted" ?>" target="_blank"><? echo $track_site_url . "/performanceAffiliateClone/index.php?Act=Affiliates&MID=$merID_Encrypted&PID=$progID_Encrypted"; ?></a></b></p>
                    </div>
                </div>
            </form>
        </div>
...
<script src="../tagsAssets/brandsTags.js" type="text/javascript"></script>
<script src="../tagsAssets/competitorURLTags.js" type="text/javascript"></script>
