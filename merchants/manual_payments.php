<?php
   ...
   if(empty($member)) $member="merchant";
   $memberid 		=$member."_id";
   ...
   <table width="90%" class="tablewbdr" align="center">
      	<tr >
           ...
           <?=$affiliate_transaction?> <select name="trans">
                ...
                <option value="add" <?echo ($trans=="add")?"selected='selected'":""?>><?=$affiliate_withdraw?></option>
                <option value="deduct" <?echo ($trans=="deduct")?"selected='selected'":""?>><?=$affiliate_payment?></option>
           </select>
   ...
   <br/>
	    <table width="90%" class="tablebdr" align="center">
	        <tr>
	                        <td colspan="4" align="center" class="textred">
	                        </td>
	        </tr>
	        <tr >
                             <td height="25" class="tdhead" align="center"><?=$affiliate_merchant?></td>
