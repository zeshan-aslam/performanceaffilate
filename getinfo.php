<?php 
 ...
 ON partners_program.program_merchantid = partners_merchant.merchant_id";
...
<div class="container m-5">
 <h1>Details</h1>
		...
		while($row=mysqli_fetch_array($res))
  {
		...
		if($category_area_name == "Other" || $category_area_name == "Retail" || $category_area_name == "Shopping"){
			$cat_status = '<p style="color:red"><b>CATEGORY = OTHER/RETAIL/SHOPPING Change it!</b></p>';
	...
	if ($status =="approved" AND $advert_error == "1"){
 ...
 <?php  
	  ...
	  <h1>ERROR REPORT (Adverts: <?php echo $advert_count; ?>)</h1><BR>
		...
		Category Errors = <?php echo $error_cat; ?> - Search: <b>"CATEGORY = OTHER/RETAIL/SHOPPING Change it!"</b><br>
