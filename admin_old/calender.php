    ...
    */
    function getMonthHTML($m, $y, $showYear = 1)
    {
        ...
        $year = $a[1];
            ...
            //$s .="<br/>\n";
            $s .="<td valign=\"top\"   width=\"40%\">\n";
            $s .= "<table width=\"60%\"  cellspacing=\"1\"  align=\"left\" class=\"tablebdr\" >\n";
            $s .= "<tr>\n";
            $s .= "<td align=\"center\" class=\"tdhead\" colspan=\"7\"><b>Calender</b></td>\n";
            $s .= "</tr>\n";
            $s .= "<tr>\n";
            $s .= "<td align=\"center\" valign=\"top\" class=\"\" >" . (($prevMonth == "") ? "&nbsp;" : "<a    href=\"".$prevMonth."\"><b>&laquo;</b></a>")  . "</td>\n";
            $s .= "<td align=\"center\" valign=\"top\" class=\"calendarHeader\" colspan=\"5\">$header</td>\n";
            $s .= "<td align=\"center\" valign=\"top\" class=\"\" >" . (($nextMonth == "") ? "&nbsp;" : "<a href=\"$nextMonth\"><b>&raquo;</b></a>")  . "</td>\n";
            $s .= "</tr>\n";
