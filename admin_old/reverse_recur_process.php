<?php	ob_start();
    ...
    $today	   			 =date("Y-m-d");
	$recur_payid 		 =$_GET['recur_payid'];
	$recurId			 =$_GET['recur_id'];
...
//end getting details	
    ...
    //geting records from table
     ...
     if($admin_pay_amount-$amount>=0)
	 {
	   	...
	   	$sql ="update partners_recurpayments set recurpayments_status='reversed' where recurpayments_id='$recur_payid' ";
	    $ret =mysqli_query($con,$sql);
		
		$sql_recur = "UPDATE partners_recur SET recur_status='Rejected' WHERE recur_id='$recurId' ";
    ...
    header("location:index.php?Act=reverse_recur_payments&msg=$msg");
    exit;
