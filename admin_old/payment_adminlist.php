<?
  ...
  //geting records from table
   $sql1 ="select *,date_format(transaction_adminpaydate,'%d-%M-%y') as date from partners_transaction,partners_joinpgm  where transaction_adminpaid>0 and  transaction_joinpgmid=joinpgm_id ";
   if(!empty($From)&& !empty($To)) $sql1 .=" and transaction_adminpaydate between '$From' and '$To' ";
   $pgsql	=$sql1;
  ...
  //checking for each records
     ...
     ?>
	    ...
	    <table width="90%" class="tablebdr" align="center">
	        <tr>
	                        <td colspan="5" align="center" class="textred">
	                        </td>
	        </tr>
	        <tr >
        ...
        <?
             while($row1=mysql_fetch_object($ret1))
             {
                 //geting records from table
                  ...
                  $sql3 ="select * from partners_affiliate where affiliate_id='$row1->joinpgm_affiliateid'";
                 ...
                 if ($row1->transaction_status=='reversed' and $row1->transaction_reversedate !="0000-00-00")
                 ...
                 ?>
                     ...
                     <td height="25"> <?=$row1->transaction_adminpaid?> </td>
    				</tr>
       ...
       ?> 	<tr>
                ...
                $url    ="index.php?Act=payment_adminlist&txtto=$cto&txtfrom=$cfrom";    //adding page nos
