...
//===================Start Decryption of MID and PID==========================//
$MID = $_GET['MID'];
$PID = $_GET['PID'];
$decrypted_MID = MultipleTimeDecode($MID);
$decrypted_PID = MultipleTimeDecode($PID);
//===================End Decryption of MID and PID==========================//

//===================Start Data for Reffere Merchant =================//
$sqlMer = "select * from partners_merchant where merchant_id='$decrypted_MID'";
$mer_res = mysqli_query($con, $sqlMer);
// echo mysqli_error($sqlMer);

while ($row = mysqli_fetch_object($mer_res)) {
...
$sqlProg = "select * from partners_program where program_id='$decrypted_PID'";
$prog_res = mysqli_query($con, $sqlProg);
// echo mysqli_error($sqlProg);

while ($row = mysqli_fetch_object($prog_res)) {
  $program_description              = stripslashes(trim($row->program_description));
  $program_cookie              = stripslashes(trim($row->program_cookie));
}


$sqlCommision = "select * from partners_pgm_commission where commission_programid='$decrypted_PID'";
$comm_res = mysqli_query($con, $sqlCommision);
// echo mysqli_error($sqlProg);

while ($row = mysqli_fetch_object($comm_res)) {
  $commission_salerate              = stripslashes(trim($row->commission_salerate));
  $commission_saletype              = stripslashes(trim($row->commission_saletype));
}
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="Signupform">
          <form id="signup-affiliate" method="post" name="reg" action="new_affil_reg_validate.php?mode=insert&MID=<?= $MID ?>&PID=<?= $PID ?>">
            ...
            <div class="mb-1 mt-1 col-md-12">
              ...
              <select id="accounttype" name="accounttype" class="custom-select form-control" required>
                <!-- <option value="">Select Account Type</option> -->
                <option value="Affiliates" selected>Affiliate</option>
            ...
            <div class="row">
              ...
              <div class="mb-1 mt-1 col-md-6">
                ...
                <input type="text" class="form-control" id="emailidtxt" name="emailidtxt" required="required" size="20" placeholder="Enter email">
              </div>
              <div class="mb-1 mt-1 col-md-6">
                <label for="pwd" class="form-label">Company:</label>
                <input type="text" class="form-control" id="companytxt" name="companytxt" required="required" size="20" placeholder="">
              </div>
              <div class="mb-1 mt-1 col-md-4">
                <label for="email" class="form-label">Phone Number:</label>
                <input type="text" class="form-control" id="phone" name="phonetxt" required="required" placeholder="Enter Phone number">
              </div>
              <div class="mb-1 mt-1 col-md-4">
                <label for="pwd" class="form-label">Url:</label>
                <input type="text" class="form-control" id="url" name="urltxt" required="required" size="20" placeholder="">
              </div>
              <div class="mb-1 mt-1 col-md-4">
                <label for="email" class="form-label">City/Town:</label>
                <input type="text" class="form-control" id="city" name="citytxt" required="required" placeholder="City/Town:">
              </div>
              ...
              <!-- <div class="mb-1 mt-1 col-md-6" id="brands">
                  ...
                  <select id="brandName" name="brands[]" class="tokenize-custom-demo1" multiple>
                  </select>
                </div> -->

              <div class="mb-1 mt-1 col-md-4">
                <label for="pwd" class="form-label">State/County</label>
                <input type="text" class="form-control" id="state" name="statetxt" required="required" placeholder="State/County">
              </div>
              <div class="mb-1 mt-1 col-md-4">
                <label for="pwd" class="form-label">Select a Country</label>
                <select id="country" name="countrylst" class="custom-select form-control" required>
                  <option value=""><?= $lang_SelectaCountry ?></option>
                  <?php
              ...
              <div class="mb-1 mt-1 col-md-4">
                ...
                <input type="text" class="form-control" id="zip-code" name="ziptxt" required="required" placeholder="Zip/Post Code">
              </div>

              <div class="mb-1 mt-1 col-md-4">
                <label for="Tax/VAT Id" class="form-label">Tax/VAT Id</label>
                <input type="text" class="form-control" placeholder="Tax/VAT Id" id="tax-id" required="required" name="taxIdtxt" size="20">
              </div>
              ...
              <div class="mb-1 mt-1 col-md-4">
                ...
                <select id="category" name="categorylst" class="custom-select form-control" required>
                  <option selected='selected' value=""><?= $selectacategory ?></option>
                  <?php
...
17.8 This agreement shall be governed by and construed in all respects in accordance with the laws of England and Wales and each party hereby submits to the exclusive jurisdiction of the courts of England and Wales.
      ...
      <div class="col-md-4">
        <!-- <div class="whyjoin">
            <h2>WHY JOIN</h2>
            <ul>
              <li>Earn revenues from your website(s) or Social Media Channels!</li>
              <li>Lastest AI & Machine Learning Cross Browser/Device tracking System!</li>
              <li>Easy Reporting Tools and API's</li>
              <li>24 hour turn-around customer service</li>
              <li>FREE use of CheckAIM Security Tool offering Merchants peace of mind!</li>
              <li>Easy to use integration (Copy & Paste)</li>
              <li>Quick payouts on commissions</li>
              <li>Access to a pool of quality PRE-PAID Merchants!</li>
            </ul>
          </div> -->
        <div class="row">
          <div class="col-md-12">
            <div class="whyjoinTest">
              <h2>Referrer Merchant</h2>
              <!-- <strong>Merchant LOGO</strong><br /> -->
              <div class="row">
                <div class="col-md-12">
                  <?php
                  if ($merchant_profileimage!="") {
                  ?>
                    <img class="mer_logo" src="<? echo "	https://performanceaffiliate.com/performanceAffiliateClone/merchants/uploadedimage/" . $merchant_profileimage ?>" id="" alt="Image">

                  <?php
                  } else {
                  ?>
                    <img class="empty_logo" src="<? echo "	https://performanceaffiliate.com/performanceAffiliateClone/merchants/uploadedimage/download (1).png" ?>" id="" alt="Image">
                  <?php
                  }
                  ?>
                </div>
              ...
              <ul>
                <?php
                if ($commission_saletype == '%') {

                ?>
                  <li><?= $commission_salerate ?> <?= $commission_saletype ?></li>
                <?php
                } else {
                ?>
                  <li><?= $commission_saletype ?><?= ($commission_salerate) ? number_format((float)$commission_salerate, 2, '.', '') : 0.00 ?></li>
                <?php
                }
                ?>

              </ul>
              <strong>Referral Period:</strong><br />
              <ul>
                <li>
                  <?= $program_cookie ?>
                </li>
