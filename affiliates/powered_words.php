				...
				<div class="container">
					<div class="row">
						...
						<div class="col col-md-6">
							...
							<form method="post" id="contrySubmitBtn-move" name="reg" action="poweredWords_Validate.php?action=multi_Country">
						...
						<div class="col col-md-6">
							...
							<form method="post" id="categorySubmitBtn-move" name="reg" action="poweredWords_Validate.php?action=multi_Category">
