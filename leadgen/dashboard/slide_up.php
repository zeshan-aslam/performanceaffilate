	...
	<div class="col-md-12">
		<div class="card stacked-form">
			...
			<div class="card-body">
				...
				<input type="hidden" name="compaign_type" value="slide_up">
			...
			<div class="row mg-t-20">
				<label class="col-sm-4 form-control-label">Form background Color: <span class="tx-danger">*</span></label>
				<div class="col-sm-8 mg-t-10 mg-sm-t-0">
				  <input type="text" name="config[form_background_color]" class="form-control jscolor" value="<?php echo $companydata['form_background_color']; ?>">
				</div>
			</div><!-- row -->
			<div class="row mg-t-20">
