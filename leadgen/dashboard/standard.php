...
<div class="row"> 
	<div class="col-md-12">
		...
		?>
			...
			<div class="row mg-t-20">
				<label class="col-sm-4 form-control-label">Affiliate Merchant Tracking: <span class="tx-danger"><br></br><br>In order to use Affiliate Tagging Please use the following Tages:
