...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>AspDotNetStorefront Integration for Lead and Sale</title>
...
<?php 	include_once '../includes/constants.php'; ?>
            ...
            <tr>
            	<td  class="MainTD" height="400" >
                	<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" >
                    	<tr>
                        	<td align="center" class="MainHead" >AspDotNetStorefront</td>
                        </tr>
						...
						<tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">Find your thank you page (post order page) file at your server and add this code into it:
                                        </td>
                                    </tr>
                        <tr>
 ...
 src="'.$track_site_url.'/trackingcode_sale.php?mid=xxx&sec_id=xxx&sale=<?=$orderAmount?>&orderId=<?=$orderId?>">
                        ...
                        <tr><td height="10" >&nbsp;</td></tr>
									<tr>
                                    	<td align="left">Integration will track total cost and order ID.
                                        </td>
                                    </tr>
                               </table>
                        	</td>
