...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>Wordpress ecommerce Plugin Integration for Lead and Sale</title>
            ...
            <tr>
            	<td  class="MainTD" height="400" >
                	<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" >
                    	<tr>
                        	<td align="center" class="MainHead" >Wordpress ecommerce Plugin</td>
                        </tr>
                        ...
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">In your wordpress installation, open and edit the file: wp-contentpluginswp-shopping-cart ransaction_result_functions.php
                        ...
                        <tr>
                        	<td align="center" class="subHead" >
                        		<img src="images/step.png" border="0" alt="LEAD Code Integration" /> 2 In transaction_result_functions.php, find this line of code:
                        	</td>
                        </tr>
                        <tr>
                    	  	<td align="left" class="leftPad" >
                        ...
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">Put one of the following integration code ABOVE the line:
										</td>
                                    </tr>
                        <tr>
