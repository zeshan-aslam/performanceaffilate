...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>Actinic Integration for Lead and Sale</title>
            ...
            <tr>
            	<td  class="MainTD" height="400" >
                	<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" >
                    	<tr>
                        	<td align="center" class="MainHead" >Actinic</td>
                        </tr>
                        <tr><td height="10" >&nbsp;</td></tr>
                        
                    	<tr>
                    	  	<td align="left" >
								Actinic is the most comprehensive low-cost ecommerce package available today. It includes everything a small business needs to design, build and manage its own secure web store. For integration follow these easy steps:
                        	</td>
                        </tr>
                    	...
                    	<tr>
                        	<td align="center" class="subHead" >
                        		<img src="images/step.png" border="0" alt="LEAD Code Integration" />1 Open order04.html file
                        	</td>
                        </tr>
						<tr>
                        	<td align="center" class="subHead" >
                        		<img src="images/step.png" border="0" alt="LEAD Code Integration" />2
Integration
                        	</td>
                        </tr>
                    	<tr>
