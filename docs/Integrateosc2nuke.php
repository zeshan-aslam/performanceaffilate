...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>osc2nuke Integration for Lead and Sale</title>
            ...
            <tr>
            	<td  class="MainTD" height="400" >
                	<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" >
                    	<tr>
                        	<td align="center" class="MainHead" >osc2nuke</td>
                        </tr>
                        <tr><td height="10" >&nbsp;</td></tr>
                        
                    	<tr>
                    	  	<td align="left" >Integration with osc2nuke is made by placing sale tracking script into the confirmation page. To obtain the values of OrderID and TotalSale, snippet connects to osc2nuke database and retrieves the values from there.
                        	</td>
                        </tr>
                        ...
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">Find and open file: modules\catalog\checkout_success.php
                                        </td>
                                    </tr>
                               </table>
                        	</td>
                       ...
                       <tr>
                        ...
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left"> Find following line in this file:
                                        </td>
                                    </tr>
									<tr>
										<td align="left">
											<textarea >require(DIR_WS_CLASSES . 'checkout_success.php');</textarea> 
										</td>
									</tr>
                               </table>
                        	</td>
                        ...
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left"> Add following code before this line:
                                        </td>
                                    </tr>
                        <tr>
