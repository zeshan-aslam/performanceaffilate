...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>Presta Shop Integration for Lead and Sale</title>
            ...
            <tr>
            	<td  class="MainTD" height="400" >
                	<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" >
                    	<tr>
                        	<td align="center" class="MainHead" >Presta Shop</td>
                        </tr>
                        <tr><td height="10" >&nbsp;</td></tr>
                        
                    	<tr>
                    	  	<td align="left" >Integration with Presta Shop need modification of some processing files. 
                        	</td>
                        </tr>
						...
						<tr>
                        	<td align="center" class="subHead" > 
                        		<img src="images/step.png" border="0" alt="LEAD Code Integration" /> 1 Localization of file
                        	</td>
                        </tr>
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">Connect to your FTP and find file order-confirmation.php . This file is processing orders. Download it, open in any text editor and find this line:
                                        </td>
                                    </tr> 
									<tr>
										<td align="left">
											<textarea >HOOK_PAYMENT_RETURN' => Hook::paymentReturn(intval($id_order), intval($id_module)))); 
											</textarea> 
										</td>
									</tr>
                               </table>
						...
						<tr>
                        	<td align="center" class="subHead" > 
                        		<img src="images/step.png" border="0" alt="LEAD Code Integration" /> 2 Tracking code
                        	</td>
                        </tr>
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">Copy and Paste the following code into the file:
                                        </td>
                                    </tr> 
                        <tr>
...
<?'; ?>
                    	...
                    	<tr>
                    	  	<td align="left" >Now save the file and upload it back.
                        	</td>
                        </tr>
