...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>Foxy Cart Integration for Lead and Sale</title>
            ...
            <tr>
            	<td  class="MainTD" height="400" >
                	<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" >
                    	<tr>
                        	<td align="center" class="MainHead" >Foxy Cart</td>
                        </tr>
                        ...
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">Log into your FoxyCart store's <b>Admin Page</b>, go to <b>Templates > Checkout </b>and click to the <b>FoxyCart Standard</b> template.
</td>
                                    </tr>
                               </table>
                        	</td>
                        ...
                        <tr>
                        	<td align="center" class="subHead" >
                        		<img src="images/step.png" border="0" alt="LEAD Code Integration" /> 2 Find correct place for integration
                        	</td>
                        </tr>
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">In the <b>Checkout Template</b> find code:</td>
                                    </tr>
                                    <tr>
                                        <td align="left">
<textarea ></body>
                        ...
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">Before tag &lt;/body> insert following code:</td>
                                    </tr>
                        <tr>
 ...
 src="'.$track_site_url.'/trackingcode_sale.php?mid=xxx&sec_id=xxx&sale=<?=$orderAmount?>&orderId=<?=$orderId?>">
                        ...
                        <tr><td height="10" >&nbsp;</td></tr>
                    	<tr>
                    	  	<td align="left" >Click to the <b>update template </b>button </td>
                        </tr>
