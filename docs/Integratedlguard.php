...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>DL Guard Integration for Lead and Sale</title>
...
<?php 	include_once '../includes/constants.php'; ?>
            ...
            <tr>
            	<td  class="MainTD" height="400" >
                	<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" >
                    	<tr>
                        	<td align="center" class="MainHead" >DL Guard</td>
                        </tr>
                        <tr><td height="10" >&nbsp;</td></tr>
                        
                    	<tr>
                    	  	<td align="left" >Please follow these steps to integrate with DL guard:	</td>
                        </tr>
                        ...
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">In DLGuard, the following code can be added into the "Extra Text/HTML Code" box on the Edit Product screen of their particular product.</td>
                                    </tr>
                        <tr>
 ...
 src="'.$track_site_url.'/trackingcode_sale.php?mid=xxx&sec_id=xxx&sale=<?=$orderAmount?>&orderId=<?=$orderId?>">
                        ...
                        <tr><td height="10" >&nbsp;</td></tr>
                                    ...
                                    <tr>
                                    	<td align="left">Affiliate Network Pro Sales Code is now integrated.</td>
                                    </tr>
                               </table>
                        	</td>
                        </tr>    
