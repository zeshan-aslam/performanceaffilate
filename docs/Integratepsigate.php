...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>PSiGate Integration for Lead and Sale</title>
            ...
            <tr>
            	<td  class="MainTD" height="400" >
                	<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" >
                    	<tr>
                        	<td align="center" class="MainHead" >PSiGate</td>
                        </tr>
                        <tr><td height="10" >&nbsp;</td></tr>
                        
                    	<tr>
                    	  	<td align="left" >PSiGate uses a variation of General solution, it tracks sales by invoking hidden script from "thank you" page.
                        	</td>
                        </tr>
                        ...
                        <tr>
                    	  	<td align="left" class="leftPad" >
                            	<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" >
									<tr>
                                    	<td align="left">Specify your own thank you page for PsiGate and put there the following code
                                        </td>
                                    </tr>
                        <tr>
...
<textarea ><?php echo '<img src="'.$track_site_url.'/trackingcode_sale.php?mid=xxx&sec_id=xxx&sale=<?=$orderAmount?>&orderId=<?=$orderId?>" height="1" width="1" alt="" />'; ?>
                    	...
                    	<tr>
                    	  	<td align="left" >This is all that is required. Now whenever there's sale, PSiGate will call our sale tracking script, and system will generate commission for the affiliate.
                        	</td>
                        </tr>
