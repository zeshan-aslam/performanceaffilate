...
<head>
    ...
    <link href="checkToken/tokenize2.css" rel="stylesheet" />
    <script src="checkToken/tokenize2.js"></script>
    <link href="checkToken/demo/demo.css" rel="stylesheet" />
    <!-- 
    <link rel="stylesheet" href="checkToken/dist/tokenize2.min.css" rel="stylesheet" />
  <link rel="stylesheet" href="checkToken/demo/demo.css" rel="stylesheet" />
  <script src="checkToken/dist/tokenize2.min.js"></script>
  -->

    <!---------------------------- Multi tags select tags autofill with enter-----------its front end exampl is on performanceaffiliate.com/test_asset.php -->
