	...
	{ ?>
		<table class="table table-hover table-striped">
                 <tr>
                    ...
                    <td>
                    	<?=$currSymbol.number_format((float)$programDetails['impression_rate'], 2, '.', '')?>&nbsp;/&nbsp;<?=$programDetails['impression_unit']?>
                    </td>
                </tr>  
                ...
                <tr>
                    ...
                    <td  ><?=$currSymbol.number_format((float)$programDetails['click'], 2, '.', '')?></td>
                </tr>  
			...
			<table class="table table-hover table-striped">
				...
				if($commissionId) { ?>
                    <tr>
                        ...
                        <td  >
                            <?=$currSymbol.number_format((float)$commissionDetails[1]['leadrate'], 2, '.', '')?>
                        </td>
                    </tr>  
                    ...
                    <tr>
						...
						<?php 
							if($commissionDetails[1]['saletype']=="%"){
									...
									echo $currSymbol.number_format((float)$commissionDetails[1]['salerate'], 2, '.', '');
								} 
								?>
                        </td>
                    </tr>  
				<?php
                    ...
                    ?>
						...
						<tr>
							...
							<td>
								<?=$currSymbol.number_format((float)$commissionDetails[$i]['leadrate'], 2, '.', '')?>
							</td>
						</tr>  
						<tr>
							<td>
							...
							<?php 
								if($commissionDetails[$i]['saletype']=="%"){
									...
									echo $currSymbol.number_format((float)$commissionDetails[$i]['salerate'], 2, '.', '');
								} 
							?>
							 </td>
						</tr>  
