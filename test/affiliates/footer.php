	<!--<table cellpadding="0" cellspacing="0" width="100%" border="0">
		...
		<tr>
			<td height="25" align="center">Copyright <?php echo date("Y"); ?> &copy; AVAZ Affiliate Network. All Rights Reserved.</td>
		</tr>
	</table>-->
<footer class="footer">
			<div class="container">
...
<div class="fixed-plugin">
	<div class="dropdown show-dropdown">
		...
		<ul class="dropdown-menu">
			...
			<li>
				<a class="img-holder switch-trigger" href="javascript:void(0)">
					<img src="../public/assets/img/sidebar-5.jpg" alt="" />
				</a>
			</li>
			<li class="header-title" id="sharrreTitle">Thank you for sharing!</li>
			<li class="button-container">
				<a target="_blank" href="https://twitter.com/AvazNetwork" id="twitter" class="btn btn-social btn-twitter btn-round twitter-sharrre"><i class="fa fa-twitter"></i></a>
				<a target="_blank" href="https://www.facebook.com/Avaz-Affiliate-Network-1637388159698131/" id="facebook" class="btn btn-social btn-facebook btn-round facebook-sharrre"><i class="fa fa-facebook-square"></i></a>
			</li>
		</ul>
	</div>
</div>
...
<!--  Share Plugin -->
<script src="../public/assets/js/plugins/jquery.sharrre.js"></script>
<!--  jVector Map  -->
<script src="../public/assets/js/plugins/jquery-jvectormap.js" type="text/javascript"></script>
<!--  Plugin for Date Time Picker and Full Calendar Plugin-->
<script src="../public/assets/js/plugins/moment.min.js"></script>
<!--  DatetimePicker   -->
<script src="../public/assets/js/plugins/bootstrap-datetimepicker.js"></script>
<!--  Sweet Alert  -->
<script src="../public/assets/js/plugins/sweetalert2.min.js" type="text/javascript"></script>
<!--  Tags Input  -->
<script src="../public/assets/js/plugins/bootstrap-tagsinput.js" type="text/javascript"></script>
<!--  Sliders  -->
<script src="../public/assets/js/plugins/nouislider.js" type="text/javascript"></script>
<!--  Bootstrap Select  -->
<script src="../public/assets/js/plugins/bootstrap-selectpicker.js" type="text/javascript"></script>
<!--  jQueryValidate  -->
<script src="../public/assets/js/plugins/jquery.validate.min.js" type="text/javascript"></script>
<!--  Plugin for the Wizard, full documentation here: https://github.com/VinceG/twitter-bootstrap-wizard -->
<script src="../public/assets/js/plugins/jquery.bootstrap-wizard.js"></script>
<!--  Bootstrap Table Plugin -->
<script src="../public/assets/js/plugins/bootstrap-table.js"></script>
<!--  DataTable Plugin -->
...
<script src="../public/assets/js/light-bootstrap-dashboard.js" type="text/javascript"></script>
